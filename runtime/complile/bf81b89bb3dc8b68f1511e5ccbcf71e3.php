...
<section class="n_container">
	<section id="n_lianxi">
		<div class="layui-container">
			<div class="layui-row">
				<div class="layui-col-xs12">
					<div class="tt1" aos="fade-up" aos-duration="1500">
						<h3>{pboot:companyname}</h3>
						<span></span>
					</div>
					<div class="con" aos="fade-up" aos-duration="1500">
						公司致力于创建技术创新、多元经营、精细管理，匹配行业系统全套解决方案，竭诚为每一位新老客户的不同需求提供优质服务。公司始终秉持“环保、节能、科技、创新”的生产经营理念，诚信的服务精神，科学的发展观，为发展人类环保事业添砖加瓦。
					</div>
					...
					<div class="lianxi_box">
						<div class="left fl">
							...
							<div class="miso_bd">
								<div>
									<dl style=" background:url({pboot:sitetplpath}/template/default/images/n_contact_icon01.png) 5px 0.125rem no-repeat">
										<dt>公司地址：</dt>
										<dd>
											<p>{pboot:companyaddress}
		
											<br>手机：{pboot:companymobile} 电话：
{pboot:companyphone}
											</p>
										</dd>
									</dl>
							...
							<dl style=" background:url(http://www.chsaiwei.com/contact/images/n_contact_icon02.png) 0 0.125rem no-repeat">
								<dt>业务咨询电话：<font>{pboot:companymobile}</font>
								</dt>
							</dl>
